...
- **B-016: MCP 公式ブログ（`blog.modelcontextprotocol.io`）を最優先ソースとして `daily-sources.md` に追加する**（起票 2026-07-29 / 最終確認 2026-08-02 / 回数 4）
...
- **B-015: Hugging Face（`huggingface.co`）をオープンウェイト系の一次ソースとして `daily-sources.md` に追加する**（起票 2026-07-28 / 最終確認 2026-08-02 / 回数 2）
...
- **B-013: 403 を「ゲートウェイ拒否」と「オリジン 403」に分類して記録する**（起票 2026-07-27 / 最終確認 2026-08-02 / 回数 7）
